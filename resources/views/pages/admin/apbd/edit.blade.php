                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ route('apbd.update', $apbd->id) }}" method="POST" id="form-id">
                                    @csrf
                                    @method('PUT')
                                    <div class="form-group row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description"
                                                rows="4" cols="50">{{ $apbd->description }}</textarea>
                                            @error('description')
                                    ...
                                    <div class="form-group row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="date" class="form-control @error('date') is-invalid @enderror"
                                                id="date" name="date" value="{{ $apbd->date }}">
                                            @error('date')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="form-group row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control @error('type') is-invalid @enderror" id="type"
                                                name="type">
                                                <option value="1" {{ $apbd->type == 1 ? 'selected' : '' }}> Pelaksanaan
                                                </option>
                                                <option value="2" {{ $apbd->type == 2 ? 'selected' : '' }}> Pendapatan
                                                </option>
                                                <option value="3" {{ $apbd->type == 3 ? 'selected' : '' }}>
                                                    Pembelanjaan
                                                </option>
                                            </select>
                                            @error('type')
