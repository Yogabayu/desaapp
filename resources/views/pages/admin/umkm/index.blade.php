                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-striped" id="umkm-table">
                                        <thead>
                                            <tr>
                                                <th>No.</th>
                                                <th style="width: 9.375rem !important">Nama UMKM</th>
                                                <th>Status</th>
                                                <th>Aksi</th>
                                            </tr>
                                        </thead>
...
@push('scripts')
    ...
    <script>
        function deleteUmkm(slug) {
            Swal.fire({
                title: 'Apakah Anda yakin?',
                text: "UMKM yang dihapus tidak dapat dikembalikan!",
                icon: 'warning',
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response.success) {
                                ...
                                $('#umkm-table').DataTable().ajax.reload();
                            } else {
                                toastr.error(response.message);
                            }
                        },
                        error: function(xhr) {
                            toastr.error('An error occurred while deleting the UMKM.');
                        }
                    });
                }
            });
