    ...
    public function update(Request $request, GeneralInfo $generalInfo)
    {
        try {
            ...
            $request->validate([
                ...
                'fb' => 'nullable|string|max:255|url',
                'wa' => 'nullable|string|max:255|url',
                'ig' => 'nullable|string|max:255|url',
